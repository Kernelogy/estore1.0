...
<section class="banner">
	...
	<div id="slideshow-banner">
		<ul>
			<li class="slideshow-item"><img src="./resource/images/banner1.jpg" alt="" /></li>
			<li class="slideshow-item"><img src="./resource/images/banner2.jpg" alt="" /></li>
			<li class="slideshow-item"><img src="./resource/images/banner3.jpg" alt="" /></li>
			<li class="slideshow-item"><img src="./resource/images/banner4.jpg" alt="" /></li>
		</ul>
	</div>
</section>
<!-- /banner section -->
...
<section class="about-w3ls" id="about">
	<div class="container-fluid">
		<div class="col-lg-6 col-md-6 col-sm-6 about-info1">
			<img src="./resource/images/about-pic.png" class="mini img-responsive slideanim" alt="">
			<h2 class="w3layouts w3 w3l agileinfo slideanim">About Us</h2>
			<img src="./resource/images/about-img.jpg" class="max img-responsive slideanim" alt="">
		</div>
...
<section class="team-w3ls slideanim" id="team">
	<div class="container">
		...
		<div class="col-lg-4 col-md-4 col-sm-4 team-agile1">
			<div class="team-info">
				<img src="./resource/images/team-img1.jpg" alt="" class="img-responsive slideanim">
		...
		<div class="col-lg-4 col-md-4 col-sm-4 team-agile2">
			<div class="team-info">
				<img src="./resource/images/team-img2.jpg" alt="" class="img-responsive slideanim">
				<div class="team-details slideanim">
		...
		<div class="col-lg-4 col-md-4 col-sm-4 team-agile3">
			<div class="team-info">
				<img src="./resource/images/team-img3.jpg" alt="" class="img-responsive slideanim">
				<div class="team-details slideanim">
        ...
        <div class="portfolio-centered">
            <div class="recentitems portfolio">
				<div class="portfolio-item graphic-design">
					...
					<img src="./resource/images/port19.jpg" alt="">
						<div class="he-view">
							<div class="bg a0" data-animate="fadeIn">
                               	<a href="./resource/images/port19.jpg" class="dmbutton a2 thumbnail" data-animate="fadeInUp" title="Literati"><i class="fa fa-search"></i></a>
                        	</div><!-- he bg -->
						</div><!-- he view -->		
					</div><!-- he wrap -->
				</div><!-- end col-12 -->
                ...
                <div class="portfolio-item web-design">
                    <div class="he-wrap tpl6">
					<img src="./resource/images/port1.jpg" alt="">
						<div class="he-view">
							<div class="bg a0" data-animate="fadeIn">
								<a href="./resource/images/port1.jpg" class="dmbutton a2 thumbnail" data-animate="fadeInUp" title="Literati"><i class="fa fa-search"></i></a>
                        	</div><!-- he bg -->
						</div><!-- he view -->		
					</div><!-- he wrap -->
				</div><!-- end col-12 -->
                ...
                <div class="portfolio-item graphic-design">
                    <div class="he-wrap tpl6">
					<img src="./resource/images/port2.jpg" alt="">
						<div class="he-view">
							<div class="bg a0" data-animate="fadeIn">
                                <a href="./resource/images/port2.jpg" class="dmbutton a2 thumbnail" data-animate="fadeInUp" title="Literati"><i class="fa fa-search"></i></a>
                        	</div><!-- he bg -->
						</div><!-- he view -->		
					</div><!-- he wrap -->
				</div><!-- end col-12 -->
                ...
                <div class="portfolio-item graphic-design">
                    <div class="he-wrap tpl6">
					<img src="./resource/images/port3.jpg" alt="">
						<div class="he-view">
							<div class="bg a0" data-animate="fadeIn">
                              	<a href="./resource/images/port3.jpg" class="dmbutton a2 thumbnail" data-animate="fadeInUp" title="Literati"><i class="fa fa-search"></i></a>
                        	</div><!-- he bg -->
						</div><!-- he view -->		
					</div><!-- he wrap -->
				</div><!-- end col-12 -->
                ...
                <div class="portfolio-item books">
                    <div class="he-wrap tpl6">
					<img src="./resource/images/port4.jpg" alt="">
						<div class="he-view">
							<div class="bg a0" data-animate="fadeIn">
								<a href="./resource/images/port4.jpg" class="dmbutton a2 thumbnail" data-animate="fadeInUp" title="Literati"><i class="fa fa-search"></i></a>
                        	</div><!-- he bg -->
						</div><!-- he view -->		
					</div><!-- he wrap -->
				</div><!-- end col-12 -->
                ...
                <div class="portfolio-item graphic-design">
                    <div class="he-wrap tpl6">
					<img src="./resource/images/port5.jpg" alt="">
						<div class="he-view">
							<div class="bg a0" data-animate="fadeIn">
                               	<a href="./resource/images/port5.jpg" class="dmbutton a2 thumbnail" data-animate="fadeInUp" title="Literati"><i class="fa fa-search"></i></a>
                        	</div><!-- he bg -->
						</div><!-- he view -->		
					</div><!-- he wrap -->
				</div><!-- end col-12 -->
                ...
                <div class="portfolio-item books">
                    <div class="he-wrap tpl6">
					<img src="./resource/images/port6.jpg" alt="">
						<div class="he-view">
							<div class="bg a0" data-animate="fadeIn">
                               	<a href="./resource/images/port6.jpg" class="dmbutton a2 thumbnail" data-animate="fadeInUp" title="Literati"><i class="fa fa-search"></i></a>
                        	</div><!-- he bg -->
						</div><!-- he view -->		
					</div><!-- he wrap -->
				</div><!-- end col-12 -->
                ...
                <div class="portfolio-item graphic-design">
                    <div class="he-wrap tpl6">
					<img src="./resource/images/port7.jpg" alt="">
						<div class="he-view">
							<div class="bg a0" data-animate="fadeIn">
                               	<a href="./resource/images/port7.jpg" class="dmbutton a2 thumbnail" data-animate="fadeInUp" title="Literati"><i class="fa fa-search"></i></a>
                        	</div><!-- he bg -->
						</div><!-- he view -->		
					</div><!-- he wrap -->
				</div><!-- end col-12 -->
                ...
                <div class="portfolio-item web-design">
                    <div class="he-wrap tpl6">
					<img src="./resource/images/port8.jpg" alt="">
						<div class="he-view">
							<div class="bg a0" data-animate="fadeIn">
                               	<a href="./resource/images/port8.jpg" class="dmbutton a2 thumbnail" data-animate="fadeInUp" title="Literati"><i class="fa fa-search"></i></a>
                        	</div><!-- he bg -->
						</div><!-- he view -->		
					</div><!-- he wrap -->
				</div><!-- end col-12 -->
			...
			<div class="portfolio-item books">
                <div class="he-wrap tpl6">
					<img src="./resource/images/port9.jpg" alt="">
						<div class="he-view">
							<div class="bg a0" data-animate="fadeIn">
                               	<a href="./resource/images/port9.jpg" class="dmbutton a2 thumbnail" data-animate="fadeInUp" title="Literati"><i class="fa fa-search"></i></a>
                        	</div><!-- he bg -->
						</div><!-- he view -->		
					</div><!-- he wrap -->
				</div><!-- end col-12 -->
				...
				<div class="portfolio-item graphic-design">
					<div class="he-wrap tpl6">
					<img src="./resource/images/port10.jpg" alt="">
						<div class="he-view">
							<div class="bg a0" data-animate="fadeIn">
                               	<a href="./resource/images/port10.jpg" class="dmbutton a2 thumbnail" data-animate="fadeInUp" title="Literati"><i class="fa fa-search"></i></a>
                        	</div><!-- he bg -->
						</div><!-- he view -->		
					</div><!-- he wrap -->
				</div><!-- end col-12 -->
                ...
                <div class="portfolio-item web-design">
                    <div class="he-wrap tpl6">
					<img src="./resource/images/port11.jpg" alt="">
						<div class="he-view">
							<div class="bg a0" data-animate="fadeIn">
                               	<a href="./resource/images/port11.jpg" class="dmbutton a2 thumbnail" data-animate="fadeInUp" title="Literati"><i class="fa fa-search"></i></a>
                        	</div><!-- he bg -->
						</div><!-- he view -->		
					</div><!-- he wrap -->
				</div><!-- end col-12 -->
                ...
                <div class="portfolio-item graphic-design">
                    <div class="he-wrap tpl6">
					<img src="./resource/images/port12.jpg" alt="">
						<div class="he-view">
							<div class="bg a0" data-animate="fadeIn">
                               	<a href="./resource/images/port12.jpg" class="dmbutton a2 thumbnail" data-animate="fadeInUp" title="Literati"><i class="fa fa-search"></i></a>
                        	</div><!-- he bg -->
						</div><!-- he view -->		
					</div><!-- he wrap -->
				</div><!-- end col-12 -->
                ...
                <div class="portfolio-item graphic-design">
                    <div class="he-wrap tpl6">
					<img src="./resource/images/port13.jpg" alt="">
						<div class="he-view">
							<div class="bg a0" data-animate="fadeIn">
                               	<a href="./resource/images/port13.jpg" class="dmbutton a2 thumbnail" data-animate="fadeInUp" title="Literati"><i class="fa fa-search"></i></a>
                        	</div><!-- he bg -->
						</div><!-- he view -->		
					</div><!-- he wrap -->
				</div><!-- end col-12 -->
                ...
                <div class="portfolio-item books">
                    <div class="he-wrap tpl6">
					<img src="./resource/images/port14.jpg" alt="">
						<div class="he-view">
							<div class="bg a0" data-animate="fadeIn">
                               	<a href="./resource/images/port14.jpg" class="dmbutton a2 thumbnail" data-animate="fadeInUp" title="Literati"><i class="fa fa-search"></i></a>
                        	</div><!-- he bg -->
						</div><!-- he view -->		
					</div><!-- he wrap -->
				</div><!-- end col-12 -->
                ...
                <div class="portfolio-item graphic-design">
                    <div class="he-wrap tpl6">
					<img src="./resource/images/port15.jpg" alt="">
						<div class="he-view">
							<div class="bg a0" data-animate="fadeIn">
                               	<a href="./resource/images/port15.jpg" class="dmbutton a2 thumbnail" data-animate="fadeInUp" title="Literati"><i class="fa fa-search"></i></a>
                        	</div><!-- he bg -->
						</div><!-- he view -->		
					</div><!-- he wrap -->
				</div><!-- end col-12 -->
                ...
                <div class="portfolio-item books">
                    <div class="he-wrap tpl6">
					<img src="./resource/images/port16.jpg" alt="">
						<div class="he-view">
							<div class="bg a0" data-animate="fadeIn">
                               	<a href="./resource/images/port16.jpg" class="dmbutton a2 thumbnail" data-animate="fadeInUp" title="Literati"><i class="fa fa-search"></i></a>
                        	</div><!-- he bg -->
						</div><!-- he view -->		
					</div><!-- he wrap -->
				</div><!-- end col-12 -->
                ...
                <div class="portfolio-item graphic-design">
                    <div class="he-wrap tpl6">
					<img src="./resource/images/port17.jpg" alt="">
						<div class="he-view">
							<div class="bg a0" data-animate="fadeIn">
                               	<a href="./resource/images/port17.jpg" class="dmbutton a2 thumbnail" data-animate="fadeInUp" title="Literati"><i class="fa fa-search"></i></a>
                        	</div><!-- he bg -->
						</div><!-- he view -->		
					</div><!-- he wrap -->
				</div><!-- end col-12 -->
                ...
                <div class="portfolio-item web-design">
                    <div class="he-wrap tpl6">
					<img src="./resource/images/port18.jpg" alt="">
						<div class="he-view">
							<div class="bg a0" data-animate="fadeIn">
                               	<a href="./resource/images/port18.jpg" class="dmbutton a2 thumbnail" data-animate="fadeInUp" title="Literati"><i class="fa fa-search"></i></a>
                        	</div><!-- he bg -->
						</div><!-- he view -->		
					</div><!-- he wrap -->
				</div><!-- end col-12 -->
		...
		<div id="myCarousel" class="carousel slide" data-ride="carousel" data-interval="5000" data-pause="hover">
			...
			<div class="carousel-inner slideanim" role="listbox">
				<div class="item active">
					<div class="test-agile">
						<div class="col-lg-4 col-md-4 col-sm-4 test-info1">
							<img src="./resource/images/test-img1.jpg" class="img-responsive" alt="">
						</div>
				...
				<div class="item">
					<div class="test-agile">
						<div class="col-lg-4 col-md-4 col-sm-4 test-info1">
							<img src="./resource/images/test-img2.jpg" class="img-responsive" alt="">
						</div>
						<div class="col-lg-8 col-md-8 col-sm-8 test-info2">
							<p class="test-p1">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam velit nisl, ullamcorper eget elit vitae, vehicula consequat neque. Nunc sit amet orci at orci blandit dictum a sed diam. Curabitur ut pharetra sem. Aliquam erat volutpat. Cras scelerisque, nunc nec vulputate hendrerit, est neque pretium velit, at vulputate tortor neque ut ex. Vivamus sollicitudin eleifend urna, vitae hendrerit neque. Etiam egestas commodo dolor ut pulvinar. Maecenas in ipsum cursus, commodo justo sed, cursus neque.<span class="line-w3ls"></span></p>
						</div>
				...
				<div class="item">
					<div class="test-agile">
						<div class="col-lg-4 col-md-4 col-sm-4 test-info1">
							<img src="./resource/images/test-img3.jpg" class="img-responsive" alt="">
						</div>
						<div class="col-lg-8 col-md-8 col-sm-8 test-info2">
							<p class="test-p1">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam velit nisl, ullamcorper eget elit vitae, vehicula consequat neque. Nunc sit amet orci at orci blandit dictum a sed diam. Curabitur ut pharetra sem. Aliquam erat volutpat. Cras scelerisque, nunc nec vulputate hendrerit, est neque pretium velit, at vulputate tortor neque ut ex. Vivamus sollicitudin eleifend urna, vitae hendrerit neque. Etiam egestas commodo dolor ut pulvinar. Maecenas in ipsum cursus, commodo justo sed, cursus neque.<span class="line-w3ls"></span></p>
						</div>
...
<section class="update-w3ls" >
	<div class="container">
		...
		<div class="col-lg-6 col-md-6 update-info1">
			<div class="update-agileits slideanim">
				<div class="col-sm-6 col-xs-6 update-agile1">
					<img src="./resource/images/update1.jpg" alt="" class="img-up slideanim">
				</div>
				<div class="col-sm-6 col-xs-6 update-agile2">
					<a href="#" data-toggle="modal" data-target="#basicModal1" class="slideanim"><h4>Nulla hendrerit</h4></a>
		...
		<div class="col-lg-6 col-md-6 update-info2">
			<div class="update-agileits slideanim">
				<div class="col-sm-6 col-xs-6 update-agile1">
					<img src="./resource/images/update2.jpg" alt="" class="img-up slideanim">
				</div>
				<div class="col-sm-6 col-xs-6 update-agile2">
					<a href="#" data-toggle="modal" data-target="#basicModal2" class="slideanim"><h4>egestas aliquam</h4></a>
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<div class="col-lg-6 col-md-6 col-sm-12">
							<img src="./resource/images/update1.jpg" alt="" class="img-responsive">
						</div>
						<div class="col-lg-6 col-md-6 col-sm-12">
		...
		<div class="modal fade" id="basicModal2" tabindex="-1" role="dialog" aria-hidden="true">
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-body">
						<div class="col-lg-6 col-md-6 col-sm-12">
							<img src="./resource/images/update2.jpg" alt="" class="img-responsive">
						</div>
						<div class="col-lg-6 col-md-6 col-sm-12">
...
<script type="text/javascript" src="./resource/js/jquery.slide.js"></script>
<script type="text/javascript">
	$('#slideshow-banner').slide({
		cdTime : 5000,      
	    controllerLeftButton : "./resource/images/left.png",    
	    controllerRightButton : "./resource/images/right.png"   
	});
</script>
...
<script src="./resource/js/retina-1.1.0.js"></script>
<!--script src="./resource/js/jquery.hoverdir.js"></script!-->
<script src="./resource/js/jquery.hoverex.min.js"></script>
